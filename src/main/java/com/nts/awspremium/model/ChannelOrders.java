...
public class ChannelOrders {
    ...
    public ChannelOrders(String channel_id, Integer home_rate, Integer direct_rate, Integer search_rate, Integer suggest_rate, Integer enabled, Integer view_percent, Integer max_thread) {
