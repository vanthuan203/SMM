...
public class FacebookOrder {
    ...
    public JSONObject facebook_like(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            if(!FacebookApi.getPost(data.getLink())){
                resp.put("error", "Invalid link");
                return resp;
            }
            String uid= FacebookApi.getUID_3(data.getLink().trim());
            if (uid == null) {
                resp.put("error", "Cant filter UID from link");
                return resp;
            }
    ...
    public JSONObject facebook_view(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            if(!FacebookApi.getVideo(data.getLink())){
                resp.put("error", "Invalid link");
                return resp;
            }
            String uid= FacebookApi.getUID_3(data.getLink().trim());
    ...
    public JSONObject facebook_member(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            if(!FacebookApi.getGroup(data.getLink())){
                resp.put("error", "Invalid link");
                return resp;
            }
            String uid= FacebookApi.getUID_3(data.getLink().trim());
    ...
    public JSONObject facebook_follower(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            if(FacebookApi.getPost(data.getLink())){
                resp.put("error", "Invalid link");
    ...
    public JSONObject facebook_comment(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            if(!FacebookApi.getPost(data.getLink())){
                resp.put("error", "Invalid link");
