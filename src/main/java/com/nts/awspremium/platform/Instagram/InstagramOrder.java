...
import com.nts.awspremium.InstagramApi;
...
public class InstagramOrder {
    ...
    public JSONObject instagram_like(DataRequest data,Service service,User user)  throws IOException, ParseException{
    ...
    public JSONObject instagram_view(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            String x_Id= InstagramApi.getPostId(data.getLink());
            if(x_Id==null){
    ...
    public JSONObject instagram_follower(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            String x_Id= InstagramApi.getInstagramId(data.getLink());
            if(x_Id==null){
                resp.put("error", "Invalid link");
                return resp;
            }
    ...
    public JSONObject instagram_comment(DataRequest data,Service service,User user)  throws IOException, ParseException{
        JSONObject resp = new JSONObject();
        try{
            String x_Id= InstagramApi.getPostId(data.getLink());
            if(x_Id==null){
