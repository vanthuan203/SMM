    ...
    public Boolean  updateTime_Pending_Task() {
        try {
            ...
            if(thread_running<thread_set){
                ...
                settingSystem.setMax_thread((settingSystem.getMax_thread()-10)>300?(settingSystem.getMax_thread()-10):300);
                settingSystemRepository.save(settingSystem);
                ...
                settingSystem.setMax_thread((settingSystem.getMax_thread()+10)<750?(settingSystem.getMax_thread()+10):750);
                settingSystemRepository.save(settingSystem);
            }
            return true;
        } catch (Exception e) {
