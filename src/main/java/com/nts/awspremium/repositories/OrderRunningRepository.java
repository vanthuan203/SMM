...
public interface OrderRunningRepository extends JpaRepository<OrderRunning,Long> {
    ...
    @Query(value = "select o.* from order_running o join service s on o.service_id=s.service_id and s.check_done=?1 where o.total>=(o.quantity+o.quantity*(s.bonus/100)) order by start_time desc",nativeQuery = true)
