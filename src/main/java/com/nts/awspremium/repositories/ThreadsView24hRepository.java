...
public interface ThreadsView24hRepository extends JpaRepository<ThreadsRepost24h,String> {
    @Modifying
    @Transactional
    @Query(value = "delete from threads_repost_24h where round((UNIX_TIMESTAMP()-time/1000)/60/60)>24;",nativeQuery = true)
