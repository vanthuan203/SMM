...
public interface AccountRepository extends JpaRepository<Account,Long> {
    ...
    @Query(value = "SELECT id  FROM account where (vps is null or vps='' or vps=' ') and running=0 and live not in(2,5) order by rand()  limit 1",nativeQuery = true)
    ...
    @Query(value = "SELECT id FROM account where vps=?1 and running=0 and live not in(2,5) order by rand() limit 1",nativeQuery = true)
