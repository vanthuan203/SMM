...
public interface AccountRepository extends JpaRepository<Account,String> {
    ...
    @Query(value = "SELECT * FROM Data.account where platform=?1 and account_id not in (select account_id from account_clone) and running=1 order by add_time asc limit 10;",nativeQuery = true)
