...
public interface AccountRepository extends JpaRepository<Account,Long> {
    ...
    @Query(value = "SELECT id  FROM account where (vps is null or vps='' or vps=' ') and running=0 and (recover like '%@truongcap3nguyenthanh.com.vn' or recover like '%@thpthoangthanh.com.vn') and (live not in(2,5) or live is null) order by rand()  limit 1",nativeQuery = true)
    ...
    @Query(value = "SELECT id FROM account where vps=?1 and running=0 and (recover like '%@truongcap3nguyenthanh.com.vn' or recover like '%@thpthoangthanh.com.vn') and (live not in(2,5) or live is null) order by rand() limit 1",nativeQuery = true)
